...
if(Username === 'Whites' && Password === 'Usman'){
    navigate('/dashboard');
}
}
...
<form className="ml-14 w-2/3" onSubmit={login}>
    <label className="block" htmlFor="Username">Username*</label>
    <input type="text" name="Username" className="border border-blue-900 w-full h-10 mt-2  p-3" id="Username" required />
    <label className="block mt-6" htmlFor="Password">Password*</label>
    <input type="password" name="Password" id="Password" className="border border-blue-900 w-full h-10 mt-2  p-3" required />
