...
return <div className={`bg-blue-900 flex justify-between sticky top-0 left-0 w-full text-white pt-6 transition-all duration-500`}>
    ...
    <div className="text-right  cursor-pointer text-md px-2 md:px-10 pt-4" id="logout">
