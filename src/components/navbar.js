...
return <div className={`bg-blue-900 flex justify-between sticky top-0 left-0 w-full text-white pt-6`}>
    ...
    <div className="text-right border-0 border-b-2 cursor-pointer border-blue-800 text-md px-2 md:px-10 pt-4" id="logout">
