...
return <div className={`bg-slate-700  lg:h-5/6 h-[90vh] fixed top-18  font-bold flex flex-col  space-y-10 py-10 ${expandWidth ? 'w-1/2 md:w-1/3 lg:w-80' : 'w-20' }  ${expandWidth ? 'flex' : 'hidden md:flex'}  overflow-auto`}  onMouseEnter={mouseEnter} onMouseLeave={mouseLeave}>
